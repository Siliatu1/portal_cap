...
const MainMenu = () => {
  ...
  useEffect(() => {
    const fotoUrl = datosUsuario?.foto || '';
  ...
  const handleNavigateLineasProducto = () => {
    ...
    if (documentoNormalizado === normalizarDocumento(documentoAsistenciaCafe)) {
      navigate('/portal/lineas-producto/asistencia');
      return;
    }

    // Verificar si es instructora de Panel Toderas
    if (documentosInstructorasToderas.map(normalizarDocumento).includes(documentoNormalizado)) {
        ...
        <div className="header-content">
          <div className="header-left">
            ...
            <div className="user-details">
              <p className="user-name" style={{ color: '#4e3416' }}>{nombreUsuario}</p>
